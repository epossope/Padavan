...
class TelemetrySeriesTests(unittest.TestCase):
    ...
    def test_export_has_bounded_numeric_latency_aggregates_only(self):
        ...
        self.assertIn("tts_prepare_start_ms", exported["groups"]["latency"])
        self.assertIn("tts_first_audio_ready_ms", exported["groups"]["latency"])
        self.assertIn("tts_playback_start_ms", exported["groups"]["latency"])
