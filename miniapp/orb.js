  ...
  function draw(ms){
    ...
    for(const canvas of document.querySelectorAll('canvas.membrane')){
      ...
      for(let layer=0;layer<6;layer++){
        ...
        surface.addColorStop(0,'#ffffff05');surface.addColorStop(.38,'#c8c9cc02');surface.addColorStop(.78,'#05060600');surface.addColorStop(.93,'#ffffff09');surface.addColorStop(1,'#ffffff24');
